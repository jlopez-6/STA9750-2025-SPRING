...
To visualize election results geographically, I imported U.S. county boundary shapefiles at a 1:20,000,000 scale from the [US Census Bureau](https://www.census.gov/geographies/mapping-files/2023/geo/carto-boundary-file.html)[@]. The code used to import and preprocess these shapefiles is shown below.
