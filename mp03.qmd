...
<div style="display: flex; flex-wrap: wrap; gap: 30px; margin-top: 30px; justify-content: center;"> <div style="flex: 1 1 560px; padding: 20px; border-radius: 20px; box-shadow: 0 0 10px #78c2ad; background-image: url('playlist_cover.jpeg'); background-size: cover; background-position: center;"> <h3 style="text-align: center;"> <a href="https://www.youtube.com/playlist?list=PLhqZr66B_GQ5XB6rDFYx6AyFXQHtce5kC" style="color: #fffefe; text-decoration: none; font-size: 60px; font-weight: bold;" target="_blank"> Valence Synth Wave </a> </h3> <div style="display: flex; justify-content: center;"> <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLhqZr66B_GQ5XB6rDFYx6AyFXQHtce5kC" title="YouTube playlist player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen> </iframe> </div> </div> </div>[^1]

[^1]: This image was generated with Google Gemini [@google-gemini].

# Appendix

This data analysis was performed using R, using packages including dplyr, ggplot2, readr, stringr, forcats, DT, and knitr [@R-core; @dplyr; @ggplot2; @readr; @stringr; @forcats2023; @DT; @knitr].
...
``` {r most-popular-tracks, echo=TRUE, eval=TRUE}
...
``` {r most-popular-no-char, echo=TRUE, eval=TRUE}
...
``` {r most-danceable, echo=TRUE, eval=TRUE}
...
``` {r longest-avg-track-length, echo=TRUE, eval=TRUE}
...
``` {r most-popular-playlist, echo=TRUE, eval=TRUE}
...
combined_heuristics |>
  ...
  datatable(
    caption = htmltools::tags$caption(
      ...
      'Table: ', htmltools::em('Songs Matching At Least 2 Compatibility Heuristics')
    ),
    options = list(
      pageLength = 25,
      scrollX = TRUE
